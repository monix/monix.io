...
[version 1.0](https://github.com/monixio/monix/tree/v1.0) was
released.
...
5. the [Task](https://monix.io/docs/2x/eval/task.html) and
   [Coeval](https://monix.io/docs/2x/eval/coeval.html) types were
   introduced
...
[monix-sample](https://github.com/monixio/monix-sample), a
